...
export default function AdminNav() {
  ...
  return (
    <nav className="bottom-nav">
      <button className={`nav-btn ${isActive('/admin') && !pathname.startsWith('/admin/') ? 'active' : pathname === '/admin' ? 'active' : ''}`} onClick={() => navigate('/admin')}>
      ...
      <button className={`nav-btn ${isActive('/admin/marketing') ? 'active' : ''}`} onClick={() => navigate('/admin/marketing')}>
