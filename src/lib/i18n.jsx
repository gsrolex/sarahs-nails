...
const translations = {
  es: {
    ...
    next: 'Siguiente',
    done_sending: 'Enviados',
    no_phone_customers: 'Ningún cliente tiene teléfono',
    customers_selected: 'seleccionados',
    password: 'Contraseña',
    enter: 'Entrar',
  ...
  en: {
    ...
    next: 'Next',
    done_sending: 'Sent',
    no_phone_customers: 'No customers have a phone number',
